...
const immutablePrototype = [];

Object.assign(immutablePrototype, {
	set(i, v) {
		return [...this.slice(0, i), v, ...this.slice(i + 1)];
	}
});

["map", "filter", "slice", "concat", "reduce", "reduceRight"].forEach(method => {
	immutablePrototype[method] = function () {
...
function Immutable(array) {
	array.__proto__ = immutablePrototype;
	Object.freeze(array);
	return array;
}
